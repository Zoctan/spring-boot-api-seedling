 ...
 * 通过自定义 MyRedisCacheManager 并继承 RedisCacheManager 来处理异常可以解决这个问题
 * <p>
...
public class MyRedisCacheManager extends RedisCacheManager implements ApplicationContextAware, InitializingBean {
    private final static Logger log = LoggerFactory.getLogger(MyRedisCacheManager.class);
    ...
    private void add(final Class clazz) {
        ReflectionUtils.doWithMethods(clazz, method -> {
            ...
            if (caching != null) {
                ...
                final CacheConfig cacheConfig = AnnotationUtils.findAnnotation(clazz, CacheConfig.class);
                if (cacheConfig != null) {
